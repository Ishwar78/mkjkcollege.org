...
<div><h1>Faculty Management</h1><p>Manage teaching and non-teaching staff information.</p></div></div>
...
<div className="note"><strong>Staff directory</strong><p>Maintain faculty names, designations, departments and profile information.</p></div>
<div className="note"><strong>Updates</strong><p>Keep staff records current whenever institutional changes occur.</p></div></aside></div></AdminLayout>
}
