...
<div><h1>Courses Management</h1><p>Manage course listings and programme information.</p></div></div>
...
<div className="note"><strong>Course catalogue</strong><p>Create, update or remove programme information shown to visitors.</p></div>
<div className="note"><strong>Publishing</strong><p>Keep programme names, eligibility and current session information aligned with official notices.</p></div></aside></div></AdminLayout>
}
